...
import 'package:nomad/insta/resources/auth_methods.dart';
...
import 'package:nomad/insta/screens/login_screen.dart';
...
import 'package:nomad/insta/widgets/text_field_input.dart';
              ...
              Stack(
                children: [
                  _image != null
                      ? CircleAvatar(
                          radius: 64,
                          backgroundImage: MemoryImage(_image ?? Uint8List(2)),
